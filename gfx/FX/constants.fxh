...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.65f; //0.6f;	//0.75f; //0.75f;
...
static const float GB_OPACITY_FAR = 0.85f;  // Transparency when camera is far //원래 0.85f
...
static const float GB_STRENGTH_CH2 = 0.9; // Opacity of top layer
